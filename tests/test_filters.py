...
def test_filter_transactions(transactions: list[dict[str, Any]], expected_filter) -> None:
    """
...
def test_filter_transactions_no_search(transactions: list[dict[str, Any]], expected_filter) -> None:
    """
