...
@pytest.fixture
def test_sort_by_date_default() -> tuple[list[dict[str, int | str]], list[dict[str, int | str]]]:
    return [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
...
@pytest.fixture
def test_sort_by_date() -> tuple[list[dict[str, int | str]], bool, list[dict[str, int | str]], bool]:
    return (
        [
            {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
            {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
...
def transactions_incorrect() -> list[dict[str, Any]]:
    return [
        ...
        {},
        {
            ...
            "state": "CANCELED",
            "date": "2018-09-12T21:27:25.241689",
            "perationAmount": {"amount": "67314.70", "currency": {"name": "USD", "code": "USD"}},
            "description": "Перевод организации",
            "from": "Visa Platinum 1246377376343588",
            "to": "Счет 14211924144426031657",
        },
